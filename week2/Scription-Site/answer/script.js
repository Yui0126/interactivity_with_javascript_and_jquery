$("nav ul li a").click(function(t) {
    ...
    $(window).on("load", function() {
        ...
        t.preventDefault(), $("#tabs > ul > li > a").css({ background: "#C8D6AF" }),
        ...
        ! function e() {
            $(`#rotator blockquote:nth-child(${t})`).fadeIn(2e3, function() {
                $(this).is("#rotator blockquote:last-child") ? setTimeout(function() {
                    $(`#rotator blockquote:nth-child(${t})`).fadeOut(2e3, function() { t = 1, e() })
                }, 7e3) : setTimeout(function() {
                    $(`#rotator blockquote:nth-child(${t})`).fadeOut(2e3, function() { t++, e() })
                }, 7e3)
            })
        }()
    }(),
